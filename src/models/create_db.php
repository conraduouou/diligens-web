...
try {
    ...
    if (!isset($row)) {
        ...
        $conn->query("CREATE TABLE `" . ROOM_LIST . "` (`id` INT(50) NULL DEFAULT NULL , `type` VARCHAR(50) NULL DEFAULT NULL , `cost` DECIMAL(50) NULL DEFAULT NULL , `media` VARCHAR(50) NULL DEFAULT NULL , `capacity` INT(50) NULL DEFAULT NULL)");
